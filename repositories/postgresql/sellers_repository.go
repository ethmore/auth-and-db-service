...
func (p *Postgresql) Insert(name, email, password, address, phonenumber string) error {
...
func (p *Postgresql) Update(name, email, password, address, phonenumber, id string) error {
...
func (p *Postgresql) GetSeller(email string) (*Seller, error) {
	var seller Seller
...
func (p *Postgresql) GetSellerNameByID(id string) (*SellerName, error) {
